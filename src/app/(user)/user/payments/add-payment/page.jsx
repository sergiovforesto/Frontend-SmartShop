...
export default function AddPayment() {
    ...
    const createPayment = async() => {
        if([fullName, expiration, cvv, cardNumber].includes('')) {
            showAlert({
        ...
        try {
            ...
            const newPayment = await axiosInstance.post('/payments', {
                fullName: fullName,
                exp: expiration,
                cvv: cvv,
    ...
    <>
      ...
      <div className="bg-white border h-full rounded-xl">
        <div className="px-10 py-8">
          <div>
            <p className="text-secundary underline">Add your payment method</p>
          </div>
